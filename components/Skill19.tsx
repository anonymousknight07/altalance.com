...
function Skill19({ directionLeft}: Props) {
  return (
    <div className="group relative flex cursor-pointer">
        ...
        initial={{
            ...
            src=" https://cdn.sanity.io/images/rh8hx4sn/production/2655b03526c4674729aa25be120941124fc90d6f-800x800.svg"
