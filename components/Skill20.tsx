...
function Skill20({ directionLeft}: Props) {
  return (
    <div className="group relative flex cursor-pointer">
        ...
        initial={{
            ...
            src=" https://cdn.sanity.io/images/rh8hx4sn/production/8cce3688b0623bafad08a5967d9d7ba33ab8d1df-640x480.svg"
