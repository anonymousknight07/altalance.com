...
function Skill18({ directionLeft}: Props) {
  return (
    <div className="group relative flex cursor-pointer">
        ...
        initial={{
            ...
            src=" https://cdn.sanity.io/images/rh8hx4sn/production/2932c6ebea958e6ebbb8dfe376b61a34faff8b40-800x800.svg"
            ...
            xl:h-29 rounded-full z-0">
              <div className="flex items-center justify-center h-full">
                <p className="text-3xl font-bold text-black opacity-100">98%</p>
              </div>
            </div>
